...
bool Display::checkColor() {
  pros::lcd::print(1, "Color of the tile: %s", (TEAM_COLOR == TeamColor::red ? "RED" : "BLUE"));
...
bool Display::checkTile() {
  pros::lcd::print(1, "Type of the tile: %s", (STARTING_POSITION == StartingPosition::front ? "FRONT" : "BACK"));
  pros::lcd::print(3, "Confirm? Left for YES, right for NO");
  while (pros::lcd::read_buttons() == 0){
    pros::delay(2);
  }
