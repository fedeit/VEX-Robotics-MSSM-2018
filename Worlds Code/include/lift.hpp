...
private:
  ...
  Motor liftMotorLeft = Motor(2, E_MOTOR_GEARSET_18, false, E_MOTOR_ENCODER_DEGREES);
  Motor liftMotorRight = Motor(9, E_MOTOR_GEARSET_18, true, E_MOTOR_ENCODER_DEGREES);
